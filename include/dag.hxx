...
class dag {
 ...
 public:
  ...
  static std::vector<node*> merge_node_vecs(std::vector<node*>&& src_nodes,
                                            std::vector<node*>&& header_nodes,
                                            std::vector<node*>&& obj_nodes);

  static std::vector<node*> create_node_vec(
      std::vector<fs::path>&& src_files, std::vector<fs::path>&& header_files,
